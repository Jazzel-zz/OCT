				...
				<div class="owl-carousel vincent_slider1i vincent_slider_main ">
					<div class="owl-item vincent_slider_main_item">
						<div class="vincent_slider_main_item_img">
							<div class=""><img src="assets/base/img/pizza_1.png" alt=""></div>
						</div>
						<h1>Vincent </h1>
					...
					<div class="owl-item vincent_slider_main_item vincent_slider_main_item1">
						<div class="vincent_slider_main_item_img">
							<div class=""><img src="assets/base/img/pizza_2.png" alt=""></div>
						</div>
					...
					<div class="owl-item vincent_slider_main_item vincent_slider_main_item1 vincent_slider_main_item2">
						<div class="vincent_slider_main_item_img">
							<div class=""><img src="assets/base/img/pizza_3.png" alt=""></div>
						</div>
						<div class="vincent_slider_main_item_cont">
							<div class="vincent_item_cont">
							<h1>Vincent Pizza.</h1>
					...
					<div class="vincent_slider_main_item vincent_slider_main_item1 vincent_slider_main_item2 vincent_slider_main_item3">
						<img src="assets/base/img/slide_2.jpg" alt="">
						<div class="vincent_slider_main_item_cont">
							<div class="vincent_item_cont">
							<h2>Making people happy </h2>
							<h1>Vincent Pizza.</h1>
						...
						<div class="row gutters">
								...
								<div class="vincent_menu1_block_item">
									...
									<div class="vincent_prod_list_image_cont">
										<div class="vincent_prod_list_image_wrapper">
											<img src="assets/base/img/6-600x600.png" alt="">
										</div>
									</div>
									<h5>Diablo</h5>
							...
							<div class="col col-3">
								<div class="vincent_menu1_block_item">
									...
									<div class="vincent_prod_list_image_cont">
										<div class="vincent_prod_list_image_wrapper">
											<img src="assets/base/img/8-600x600.png" alt="">
										</div>
									</div>
									<h5>Carbonara</h5>
									<p class="vincent_prod_list_text">Classic marinara sauce, authentic old-<wbr>world pepperoni, all-natural Ita</p>
							...
							<div class="col col-3">
								<div class="vincent_menu1_block_item">
									...
									<div class="vincent_prod_list_image_cont">
										<div class="vincent_prod_list_image_wrapper">
											<img src="assets/base/img/4-600x600.png" alt="">
										</div>
									</div>
									<h5>Capricciosa</h5>
									<p class="vincent_prod_list_text">Classic marinara sauce, authentic old-<wbr>world pepperoni, all-natural Ita</p>
							...
							<div class="col col-3">
								<div class="vincent_menu1_block_item">
									...
									<div class="vincent_prod_list_image_cont">
										<div class="vincent_prod_list_image_wrapper">
											<img src="assets/base/img/7-600x600.png" alt="">
										</div>
									</div>
									<h5>Prosciutto</h5>
									<p class="vincent_prod_list_text">Classic marinara sauce, authentic old-<wbr>world pepperoni, all-natural Ita</p>
						...
						<div class="row">
							<div class="col col-6">
								<div class="vincent_legend_block1">
									...
									<img class="" src="assets/base/img/separator_dark.png" alt="">
							...
							<div class="col col-6">
								<div class="vincent_legend_block2">
									<blockquote>Vincent was one of the first restaurants I discovered upon moving to New York last summer, and it remains a favorite. Despite its sizable menu full of pastas, sandwiches, and pizzas, I almost always get the same thing – the Vincent pizza. It’s made with Ricotta & Marinara sauces, spiced with oregano, and topped with eggplant, red onions, basil, Pecorino Romano & Mozzarella. It really is one of the best pizzas I’ve ever had – and I eat a lot of pizza.</blockquote>
									<div class="vincent_testimonials_author_cont">
										<img   src="assets/base/img/testimonial_1-200x200.jpg" alt="">
										<div class="vincent_testimonial_author">Adam Jefferson</div>
										<div class="vincent_author_position">Lawyer, New York</div>
									</div>
									<blockquote>The pizza is delicious! The crust is thin and crispy, great sauce, and awesome cheese blend. And it makes a cute cheap date!</blockquote>
									<div class="vincent_testimonials_author_cont">
										<img   src="assets/base/img/testimonial_2-200x200.jpg" alt="">
										<div class="vincent_testimonial_author">SAMANTHA GREENBERG</div>
									...
									<div class="vincent_menu1_block_item">
										<div class="vincent_prod_list_image_cont">
											<div class="vincent_prod_list_image_wrapper">
												...
												<img src="assets/base/img/12-3-600x600.png" alt="">
												<a class="vincent_add_to_cart_button" href="product.html"></a>
											</div>
										</div>
										<h5><a href="product.html">Vincent</a></h5>
										<p class="vincent_prod_list_text">Classic marinara sauce, authentic old-<wbr>world pepperoni, all-natural Ita</p>
											<div class="vincent_prod_list_price"><span>$</span>2.60</div>
										</div>
									</div>
									<div class="col col-3">
										<div class="vincent_menu1_block_item">
											<div class="vincent_prod_list_image_cont">
												<div class="vincent_prod_list_image_wrapper">
													<div class="vincent_team_overlay"></div>
													<img src="assets/base/img/11-3-600x600.png" alt="">
													<a class="vincent_add_to_cart_button" href="product.html"></a>
												</div>
											</div>
										...
										<div class="col col-3">
											<div class="vincent_menu1_block_item">
												<div class="vincent_prod_list_image_cont">
													<div class="vincent_prod_list_image_wrapper">
														<div class="vincent_team_overlay"></div>
														<img src="assets/base/img/10-3-600x600.png" alt="">
														<a class="vincent_add_to_cart_button" href="product.html"></a>
													</div>
												</div>
											...
											<div class="col col-3">
												<div class="vincent_menu1_block_item">
													<div class="vincent_prod_list_image_cont">
														<div class="vincent_prod_list_image_wrapper">
															<div class="vincent_team_overlay"></div>
															<img src="assets/base/img/9-3-600x600.png" alt="">
															<a class="vincent_add_to_cart_button" href="product.html"></a>
														</div>
													</div>
												...
												<div class="col col-3">
													<div class="vincent_menu1_block_item">
														<div class="vincent_prod_list_image_cont">
															<div class="vincent_prod_list_image_wrapper">
																<div class="vincent_team_overlay"></div>
																<img src="assets/base/img/8-3-600x600.png" alt="">
																<a class="vincent_add_to_cart_button" href="product.html"></a>
															</div>
														</div>
													...
													<div class="col col-3">
														<div class="vincent_menu1_block_item">
															<div class="vincent_prod_list_image_cont">
																<div class="vincent_prod_list_image_wrapper">
																	<div class="vincent_team_overlay"></div>
																	<img src="assets/base/img/7-3-600x600.png" alt="">
																	<a class="vincent_add_to_cart_button" href="product.html"></a>
																</div>
															</div>
														...
														<div class="col col-3">
															<div class="vincent_menu1_block_item">
																<div class="vincent_prod_list_image_cont">
																	<div class="vincent_prod_list_image_wrapper">
																		<div class="vincent_team_overlay"></div>
																		<img src="assets/base/img/6-3-600x600.png" alt="">
																		<a class="vincent_add_to_cart_button" href="product.html"></a>
																	</div>
																</div>
															...
															<div class="col col-3">
																<div class="vincent_menu1_block_item">
																	<div class="vincent_prod_list_image_cont">
																		<div class="vincent_prod_list_image_wrapper">
																			<div class="vincent_team_overlay"></div>
																			<img src="assets/base/img/5-3-600x600.png" alt="">
																			<a class="vincent_add_to_cart_button" href="product.html"></a>
																		</div>
																	</div>
								...
								<div class="col col-3">
									<div class="vincent_menu1_block_item">
										<div class="vincent_prod_list_image_cont">
											<div class="vincent_prod_list_image_wrapper">
												<div class="vincent_team_overlay"></div>
												<img src="assets/base/img/deserts/12-4-600x600.png" alt="">
												<a class="vincent_add_to_cart_button" href="product.html"></a>
											</div>
										</div>
									...
									<div class="col col-3">
										<div class="vincent_menu1_block_item">
											<div class="vincent_prod_list_image_cont">
												<div class="vincent_prod_list_image_wrapper">
													<div class="vincent_team_overlay"></div>
													<img src="assets/base/img/deserts/11-4-600x600.png" alt="">
													<a class="vincent_add_to_cart_button" href="product.html"></a>
												</div>
											</div>
										...
										<div class="col col-3">
											<div class="vincent_menu1_block_item">
												<div class="vincent_prod_list_image_cont">
													<div class="vincent_prod_list_image_wrapper">
														<div class="vincent_team_overlay"></div>
														<img src="assets/base/img/deserts/10-4-600x600.png" alt="">
														<a class="vincent_add_to_cart_button" href="product.html"></a>
													</div>
												</div>
											...
											<div class="col col-3">
												<div class="vincent_menu1_block_item">
													<div class="vincent_prod_list_image_cont">
														<div class="vincent_prod_list_image_wrapper">
															<div class="vincent_team_overlay"></div>
															<img src="assets/base/img/deserts/9-4-600x600.png" alt="">
															<a class="vincent_add_to_cart_button" href="product.html"></a>
														</div>
													</div>
												...
												<div class="col col-3">
													<div class="vincent_menu1_block_item">
														<div class="vincent_prod_list_image_cont">
															<div class="vincent_prod_list_image_wrapper">
																<div class="vincent_team_overlay"></div>
																<img src="assets/base/img/deserts/8-4-600x600.png" alt="">
																<a class="vincent_add_to_cart_button" href="product.html"></a>
															</div>
														</div>
													...
													<div class="col col-3">
														<div class="vincent_menu1_block_item">
															<div class="vincent_prod_list_image_cont">
																<div class="vincent_prod_list_image_wrapper">
																	<div class="vincent_team_overlay"></div>
																	<img src="assets/base/img/deserts/7-4-600x600.png" alt="">
																	<a class="vincent_add_to_cart_button" href="product.html"></a>
																</div>
															</div>
														...
														<div class="col col-3">
															<div class="vincent_menu1_block_item">
																<div class="vincent_prod_list_image_cont">
																	<div class="vincent_prod_list_image_wrapper">
																		<div class="vincent_team_overlay"></div>
																		<img src="assets/base/img/deserts/6-4-600x600.png" alt="">
																		<a class="vincent_add_to_cart_button" href="product.html"></a>
																	</div>
																</div>
															...
															<div class="col col-3">
																<div class="vincent_menu1_block_item">
																	<div class="vincent_prod_list_image_cont">
																		<div class="vincent_prod_list_image_wrapper">
																			<div class="vincent_team_overlay"></div>
																			<img src="assets/base/img/deserts/5-4-600x600.png" alt="">
																			<a class="vincent_add_to_cart_button" href="product.html"></a>
																		</div>
																	</div>
								...
								<div class="col col-3">
									<div class="vincent_menu1_block_item">
										<div class="vincent_prod_list_image_cont">
											<div class="vincent_prod_list_image_wrapper">
												<div class="vincent_team_overlay"></div>
												<img src="assets/base/img/drinks/1-5-600x600.png" alt="">
												<a class="vincent_add_to_cart_button" href="product.html"></a>
											</div>
										</div>
									...
									<div class="col col-3">
										<div class="vincent_menu1_block_item">
											<div class="vincent_prod_list_image_cont">
												<div class="vincent_prod_list_image_wrapper">
													<div class="vincent_team_overlay"></div>
													<img src="assets/base/img/drinks/2-5-600x600.png" alt="">
													<a class="vincent_add_to_cart_button" href="product.html"></a>
												</div>
											</div>
										...
										<div class="col col-3">
											<div class="vincent_menu1_block_item">
												<div class="vincent_prod_list_image_cont">
													<div class="vincent_prod_list_image_wrapper">
														<div class="vincent_team_overlay"></div>
														<img src="assets/base/img/drinks/3-5-600x600.png" alt="">
														<a class="vincent_add_to_cart_button" href="product.html"></a>
													</div>
												</div>
											...
											<div class="col col-3">
												<div class="vincent_menu1_block_item">
													<div class="vincent_prod_list_image_cont">
														<div class="vincent_prod_list_image_wrapper">
															<div class="vincent_team_overlay"></div>
															<img src="assets/base/img/drinks/4-5-600x600.png" alt="">
															<a class="vincent_add_to_cart_button" href="product.html"></a>
														</div>
													</div>
												...
												<div class="col col-3">
													<div class="vincent_menu1_block_item">
														<div class="vincent_prod_list_image_cont">
															<div class="vincent_prod_list_image_wrapper">
																<div class="vincent_team_overlay"></div>
																<img src="assets/base/img/drinks/5-5-600x600.png" alt="">
																<a class="vincent_add_to_cart_button" href="product.html"></a>
															</div>
														</div>
													...
													<div class="col col-3">
														<div class="vincent_menu1_block_item">
															<div class="vincent_prod_list_image_cont">
																<div class="vincent_prod_list_image_wrapper">
																	<div class="vincent_team_overlay"></div>
																	<img src="assets/base/img/drinks/6-5-600x600.png" alt="">
																	<a class="vincent_add_to_cart_button" href="product.html"></a>
																</div>
															</div>
														...
														<div class="col col-3">
															<div class="vincent_menu1_block_item">
																<div class="vincent_prod_list_image_cont">
																	<div class="vincent_prod_list_image_wrapper">
																		<div class="vincent_team_overlay"></div>
																		<img src="assets/base/img/drinks/7-5-600x600.png" alt="">
																		<a class="vincent_add_to_cart_button" href="product.html"></a>
																	</div>
																</div>
															...
															<div class="col col-3">
																<div class="vincent_menu1_block_item">
																	<div class="vincent_prod_list_image_cont">
																		<div class="vincent_prod_list_image_wrapper">
																			<div class="vincent_team_overlay"></div>
																			<img src="assets/base/img/drinks/8-5-600x600.png" alt="">
																			<a class="vincent_add_to_cart_button" href="product.html"></a>
																		</div>
																	</div>
								...
								<div class="col col-3">
									<div class="vincent_menu1_block_item">
										<div class="vincent_prod_list_image_cont">
											<div class="vincent_prod_list_image_wrapper">
												<div class="vincent_team_overlay"></div>
												<img src="assets/base/img/pasta/12-2-600x600.png" alt="">
												<a class="vincent_add_to_cart_button" href="product.html"></a>
											</div>
										</div>
									...
									<div class="col col-3">
										<div class="vincent_menu1_block_item">
											<div class="vincent_prod_list_image_cont">
												<div class="vincent_prod_list_image_wrapper">
													<div class="vincent_team_overlay"></div>
													<img src="assets/base/img/pasta/11-2-600x600.png" alt="">
													<a class="vincent_add_to_cart_button" href="product.html"></a>
												</div>
											</div>
										...
										<div class="col col-3">
											<div class="vincent_menu1_block_item">
												<div class="vincent_prod_list_image_cont">
													<div class="vincent_prod_list_image_wrapper">
														<div class="vincent_team_overlay"></div>
														<img src="assets/base/img/pasta/10-2-600x600.png" alt="">
														<a class="vincent_add_to_cart_button" href="product.html"></a>
													</div>
												</div>
											...
											<div class="col col-3">
												<div class="vincent_menu1_block_item">
													<div class="vincent_prod_list_image_cont">
														<div class="vincent_prod_list_image_wrapper">
															<div class="vincent_team_overlay"></div>
															<img src="assets/base/img/pasta/9-2-600x600.png" alt="">
															<a class="vincent_add_to_cart_button" href="product.html"></a>
														</div>
													</div>
												...
												<div class="col col-3">
													<div class="vincent_menu1_block_item">
														<div class="vincent_prod_list_image_cont">
															<div class="vincent_prod_list_image_wrapper">
																<div class="vincent_team_overlay"></div>
																<img src="assets/base/img/pasta/8-2-600x600.png" alt="">
																<a class="vincent_add_to_cart_button" href="product.html"></a>
															</div>
														</div>
													...
													<div class="col col-3">
														<div class="vincent_menu1_block_item">
															<div class="vincent_prod_list_image_cont">
																<div class="vincent_prod_list_image_wrapper">
																	<div class="vincent_team_overlay"></div>
																	<img src="assets/base/img/pasta/7-2-600x600.png" alt="">
																	<a class="vincent_add_to_cart_button" href="product.html"></a>
																</div>
															</div>
														...
														<div class="col col-3">
															<div class="vincent_menu1_block_item">
																<div class="vincent_prod_list_image_cont">
																	<div class="vincent_prod_list_image_wrapper">
																		<div class="vincent_team_overlay"></div>
																		<img src="assets/base/img/pasta/6-2-600x600.png" alt="">
																		<a class="vincent_add_to_cart_button" href="product.html"></a>
																	</div>
																</div>
															...
															<div class="col col-3">
																<div class="vincent_menu1_block_item">
																	<div class="vincent_prod_list_image_cont">
																		<div class="vincent_prod_list_image_wrapper">
																			<div class="vincent_team_overlay"></div>
																			<img src="assets/base/img/pasta/5-2-600x600.png" alt="">
																			<a class="vincent_add_to_cart_button" href="product.html"></a>
																		</div>
																	</div>
								...
								<div class="col col-3">
									<div class="vincent_menu1_block_item">
										<div class="vincent_prod_list_image_cont">
											<div class="vincent_prod_list_image_wrapper">
												<div class="vincent_team_overlay"></div>
												<img src="assets/base/img/11-600x600.png" alt="">
												<a class="vincent_add_to_cart_button" href="product.html"></a>
											</div>
										</div>
										<h5><a href="product.html">Margherita</a></h5>
									...
									<div class="col col-3">
										<div class="vincent_menu1_block_item">
											<div class="vincent_prod_list_image_cont">
												<div class="vincent_prod_list_image_wrapper">
													<div class="vincent_team_overlay"></div>
													<img src="assets/base/img/10-600x600.png" alt="">
													<a class="vincent_add_to_cart_button" href="product.html"></a>
												</div>
											</div>
											<h5><a href="product.html">Vincent</a></h5>
											<p class="vincent_prod_list_text">Classic marinara sauce, authentic old-<wbr>world pepperoni, all-natural Ita</p>
												<div class="vincent_prod_list_price"><span>$</span>2.00 - <span>$</span>12.00</div>
											</div>
										</div>
										<div class="col col-3">
											<div class="vincent_menu1_block_item">
												<div class="vincent_prod_list_image_cont">
													<div class="vincent_prod_list_image_wrapper">
														<div class="vincent_team_overlay"></div>
														<img src="assets/base/img/2-600x600.png" alt="">
														<a class="vincent_add_to_cart_button" href="product.html"></a>
													</div>
												</div>
															...
															<div class="col col-3">
																<div class="vincent_menu1_block_item">
																	<div class="vincent_prod_list_image_cont">
																		<div class="vincent_prod_list_image_wrapper">
																			<div class="vincent_team_overlay"></div>
																			<img src="assets/base/img/9-600x600.png" alt="">
																			<a class="vincent_add_to_cart_button" href="product.html"></a>
																		</div>
																	</div>
								...
								<div class="col col-3">
									<div class="vincent_menu1_block_item">
										<div class="vincent_prod_list_image_cont">
											<div class="vincent_prod_list_image_wrapper">
												<div class="vincent_team_overlay"></div>
												<img src="assets/base/img/salads/12-1-600x600.png" alt="">
												<a class="vincent_add_to_cart_button" href="product.html"></a>
											</div>
										</div>
									...
									<div class="col col-3">
										<div class="vincent_menu1_block_item">
											<div class="vincent_prod_list_image_cont">
												<div class="vincent_prod_list_image_wrapper">
													<div class="vincent_team_overlay"></div>
													<img src="assets/base/img/salads/3-1-600x600.png" alt="">
													<a class="vincent_add_to_cart_button" href="product.html"></a>
												</div>
											</div>
										...
										<div class="col col-3">
											<div class="vincent_menu1_block_item">
												<div class="vincent_prod_list_image_cont">
													<div class="vincent_prod_list_image_wrapper">
														<div class="vincent_team_overlay"></div>
														<img src="assets/base/img/salads/10-1-600x600.png" alt="">
														<a class="vincent_add_to_cart_button" href="product.html"></a>
													</div>
												</div>
											...
											<div class="col col-3">
												<div class="vincent_menu1_block_item">
													<div class="vincent_prod_list_image_cont">
														<div class="vincent_prod_list_image_wrapper">
															<div class="vincent_team_overlay"></div>
															<img src="assets/base/img/salads/11-1-600x600.png" alt="">
															<a class="vincent_add_to_cart_button" href="product.html"></a>
														</div>
													</div>
												...
												<div class="col col-3">
													<div class="vincent_menu1_block_item">
														<div class="vincent_prod_list_image_cont">
															<div class="vincent_prod_list_image_wrapper">
																<div class="vincent_team_overlay"></div>
																<img src="assets/base/img/salads/9-1-600x600.png" alt="">
																<a class="vincent_add_to_cart_button" href="product.html"></a>
															</div>
														</div>
													...
													<div class="col col-3">
														<div class="vincent_menu1_block_item">
															<div class="vincent_prod_list_image_cont">
																<div class="vincent_prod_list_image_wrapper">
																	<div class="vincent_team_overlay"></div>
																	<img src="assets/base/img/salads/8-1-600x600.png" alt="">
																	<a class="vincent_add_to_cart_button" href="product.html"></a>
																</div>
															</div>
														...
														<div class="col col-3">
															<div class="vincent_menu1_block_item">
																<div class="vincent_prod_list_image_cont">
																	<div class="vincent_prod_list_image_wrapper">
																		<div class="vincent_team_overlay"></div>
																		<img src="assets/base/img/salads/7-1-600x600.png" alt="">
																		<a class="vincent_add_to_cart_button" href="product.html"></a>
																	</div>
																</div>
															...
															<div class="col col-3">
																<div class="vincent_menu1_block_item">
																	<div class="vincent_prod_list_image_cont">
																		<div class="vincent_prod_list_image_wrapper">
																			<div class="vincent_team_overlay"></div>
																			<img src="assets/base/img/salads/6-1-600x600.png" alt="">
																			<a class="vincent_add_to_cart_button" href="product.html"></a>
																		</div>
																	</div>
			...
			<div class="vincent_something_blog">
				<div class="vincent_container">
					<div class="vincent_content_title_block vincent_content_title_block_light">
						...
						<h1 class="">Something From the Blog</h1>
						<img class="vincent_single_img" src="assets/base/img/separator_dark.png" alt="">
					...
					<div class="row vincent_blog_wrapper">
						<div class="col col-3">
							<div class="vincent_post_item">
								...
								<h5 class="vincent_post_title">Healsy Food for healthy body</h5>
						...
						<div class="col col-3">
							<div class="vincent_post_item">
								<div class="vincent_post_date">April 6, 2017</div>
								<h5 class="vincent_post_title">food design trends 2017</h5>
						...
						<div class="col col-3">
							<div class="vincent_post_item">
								<div class="vincent_post_date">April 6, 2017</div>
								<h5 class="vincent_post_title">3 Ingredient Fettuccine Alfredo</h5>
						...
						<div class="col col-3">
							<div class="vincent_post_item">
								<div class="vincent_post_date">April 6, 2017</div>
								<h5 class="vincent_post_title">Kitchen Essentials Giveaway!</h5>
