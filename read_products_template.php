...
while ($row = $stmt->fetch(PDO::FETCH_ASSOC)){
    ...
    echo "<div class='col-md-4 m-b-20px'>";
        ...
        echo "<div class='product-id display-none' style='display:none'>{$id}</div>";
        ...
        echo "<div class='m-b-10px'>";
            if(array_key_exists($id, $_SESSION['cart'])){
                ...
                echo "<a href='add_to_cart.php?id={$id}&page={$page}' class='btn btn-primary w-100' style='width:100%'>Add to Cart</a>";
            }
        echo "</div>";
